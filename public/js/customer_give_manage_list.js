...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "销售1", "销售2", "合同金额", "赠送项", "赠送成本", "卖家账号", "修改时间", "成交时间"];

	var indexs = ["company_name", "shop_name", "sale_user_name_1", "sale_user_name_2", "contract_amount", "give_info", "cost_sum", "seller_account", "modified", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerGiveManageList";
