...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["类型", "状态", "公司名称", "店铺名称", "卖家账号", "软件版本", "是否独享", "正式/测试", "客户负责人", "负责人联系方式", "负责人邮箱", "第三方系统名称", "对接类型", "对接业务", "审核备注", "收款金额", "实施工程师", "创建人", "创建时间"];

	var indexs = ["type", "status", "company_name", "shop_name", "seller_account", "order_name", "is_share", "is_formal", "link_man", "link_tel", "link_email", "other_system_name", "other_type", "other_business", "remark", "warehouse_amount", "imp_name", "user_name", "created"]; //相当于sql的表头
	...
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerWarehouseApplyList";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerController&act=customerWarehouseApplyList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerController&act=customerWarehouseApplyList&" + page_data);
