...
/***/ function(module, exports, __webpack_require__) {
	...
	var BodyTableComponent = __webpack_require__(169);
	var MainMenu = __webpack_require__(170);
	var TurnPageComponent = __webpack_require__(171);
	var TabComponent = __webpack_require__(172);

	var heads = ["销售1", "销售2", "公司名称", "店铺名称", "状态", "所属行业", "所属类目", "所在省", "所在市", "店铺规模", "客户预算", "客户来源", "现用软件", "提供者", "创建者", "电话销售", "修改时间", "创建时间"];

	var indexs = ["sale_user_name_1", "sale_user_name_2", "company_name", "shop_name", "status", "industry_name", "cate_name", "province_name", "city_name", "shop_scale", "customer_budget", "source_name", "soft_name", "supplier_name", "creator_name", "tel_name", "modified", "created"]; //相当于sql的表头

	var table_rows = result;
	var user_flags = flags;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改客户", "class2": "btn_chg", "target": "#customer_info_chg", "name": "" }, { "title": "添加事件", "class2": "add_event", "target": "#add_event_list", "name": "" }, { "title": "添加任务", "class2": "add_task", "target": "#add_task_list", "name": "" }, { "title": "查看私密信息", "class2": "imporant_message", "target": "#check_important_message", "name": "" }, { "title": "设置回访", "class2": "set_visit", "target": "#set_visit_list", "name": "" }, { "title": "转给销售", "class2": "create_survey", "target": "#transfer_sales_list", "name": "" }, { "title": "客户成交", "class2": "create_survey", "target": "#create_survey_list", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerIntentionList";

	var tabs = [{ name: "日志", url: "?controller=CustomerProcessController&act=customerLogList" }, { name: "事件", url: "?controller=EventController&act=getEventListByID" }, { name: "任务", url: "?controller=TaskController&act=getTaskListByID" }];
	...
	var SelectComponent = React.createClass({
		...
		onChangeValue: function onChangeValue() {
			...
			var dom = ReactDOM.findDOMNode(this.refs[name]);
			var value = $(dom).val();
			var name = this.props.name;
		...
		/*	componentWillMount:function(){
	 		$.ajax({
	      		...
	      		success:function(data){
	      			 rows=[];
	      			 rows.push(<option value='0'>全部</option>);
	      			data.forEach(function(result){
	 	     				rows.push(<option key={result.id} value={result.id}>{result.name}</option>);
	      			});
		...
		render: function render() {
			...
			return React.createElement(
				'select',
				{ className: 'selectpicker ', key: this.props.name, onChange: this.onChangeValue, multiple: this.props.multiple, 'data-live-search': 'true', ref: this.props.name, id: 'test' },
				rows
			);
		}
	});
	...
	var SearchFormComponent = React.createClass({
		...
		render: function render() {
			...
			if (this.props.flags == null) {
				...
				this.props.flags.forEach(function (flag) {
					rows.push(React.createElement(
						'option',
						{ value: flag.flag_id },
						flag.flag_name
			...
			return React.createElement(
				'form',
				{ ref: this.props.name, style: { padding: '5px' }, key: 'serach_form_list', id: 'serach_form_list' },
				React.createElement(
					'table',
					null,
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'company_name' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'shop_name' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'linkman' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'mobile' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'button', onClick: this.handleSubmit, value: '查找' })
						),
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'button', style: { width: '5px' }, id: 'btn_toggle_search', value: '...' })
						)
					),
					React.createElement(
						'tr',
						{ 'data-search-toggle': 'hide' },
						React.createElement(
							'td',
							null,
							'客户意向度:'
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=1', name: 'sales' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=2', name: 'tel_sale_user_id' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserAll', name: 'supplier_id' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=DictDataController&act=getDictData&type=3&index=1', name: 'region_id' })
						)
					),
					React.createElement(
						'tr',
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'begin_date' })
						),
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'end_date' })
						),
						'标记:',
						React.createElement(
							'select',
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'a',
					{ href: '?controller=EventController&act=checkEventList' },
					React.createElement(
						'button',
						null,
						'查看事件'
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#tel_assign_list' },
					'分配电销'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#customer_event_check' },
					'查看进程'
				)
			);
		}
	...
	var is_success = 0;
	var TelAssign = React.createClass({
		displayName: 'TelAssign',

		telAssign: function telAssign() {
			var customer_id = $("#body_table_list ").find(".tr_selected").attr("data-id");

			var assign_tel_sale_user_id = search_data['assign_tel_sale_user_id'];
			var url = "?controller=CustomerProcessController&act=customerAssignTel";

			$.post(url, { customer_id: customer_id, tel_sale_user_id: assign_tel_sale_user_id }, function (result) {
				if (result == true) {
		...
		render: function render() {
			...
			return React.createElement(
				'div',
				{ className: 'modal fade', id: 'tel_assign_list', tabindex: '-1', role: 'dialog',
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'modal-body', style: { width: "auto" } },
							React.createElement(
								'form',
								{ id: 'tel_assign_form' },
								React.createElement('input', { type: 'hidden', ref: 'customer_id' }),
								React.createElement(
									'label',
									null,
									'电销'
								),
								React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=2', name: 'assign_tel_sale_user_id' }),
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ type: 'button', className: 'btn btn-primary', onClick: this.telAssign },
								'分配电销'
							)
						)
					)
	...
	var cur_page = 1;
	var CustomerIntentionList = React.createClass({
		displayName: 'CustomerIntentionList',

		getInitialState: function getInitialState() {
			return { rows: table_rows, search_data: '', page: page_turn };
		},
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				type: 'POST',
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerIntentionList&" + data);
		...
		handleSearch: function handleSearch() {
			var old_data2 = old_data + "&page=" + cur_page;
			$.ajax({
				url: this.props.url,
				dataType: 'json',
				type: 'POST',
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerIntentionList&" + page_data);
					this.setState({ rows: result.result, page: result.page });
				}.bind(this),
				error: function (xhr, status, err) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(SearchFormComponent, { onSearchSubmit: this.onSearchSubmit, name: 'search_form', flags: user_flags }),
				React.createElement(SearchButton, { flags: user_flags }),
				React.createElement(BodyTableComponent, { heads: heads, indexs: indexs, rows: this.state.rows, operates: operates }),
				React.createElement(TurnPageComponent, { page: this.state.page, handleTablePage: this.handleTablePage }),
				React.createElement(TabComponent, { tabs: tabs }),
				React.createElement(TelAssign, { handleSearch: this.handleSearch })
			);
		}
	});
	ReactDOM.render(React.createElement(CustomerIntentionList, { url: url }), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableHeadRowComponent = React.createClass({
		displayName: 'TableHeadRowComponent',
	...
	var TdOperateComponent = React.createClass({
		displayName: 'TdOperateComponent',
			...
			this.props.operates.forEach(function (operate) {
				if (operate.name != "") {
					buttons.push(React.createElement(
						'button',
						{ className: operate.class2, 'data-toggle': 'modal', title: operate.title,
							'data-target': operate.target },
						operate.name
					));
				} else {
					buttons.push(React.createElement('button', { className: operate.class2, 'data-toggle': 'modal', title: operate.title,
						'data-target': operate.target }));
				}
			}.bind(this));
			return React.createElement(
	...
	var TableCommonRowComponent = React.createClass({
		displayName: 'TableCommonRowComponent',
		...
		render: function render() {
			...
			if (this.props.row.bg_color == null) {
				return React.createElement(
					'tr',
					{ onClick: this.onClickRow, 'data-id': this.props.row.rec_id, 'data-work_id': this.props.row.work_id, 'data-customer_id': this.props.row.customer_id, 'data-type': this.props.row.type, 'data-seller_id': this.props.row.seller_id },
					React.createElement(TdOperateComponent, { operates: this.props.operates }),
					tds
				);
			} else {
				return React.createElement(
					'tr',
					{ onClick: this.onClickRow, 'data-id': this.props.row.rec_id, 'data-work_id': this.props.row.work_id, 'data-customer_id': this.props.row.customer_id, 'data-seller_id': this.props.row.seller_id, 'data-type': this.props.row.type, style: { background: '#' + this.props.row.bg_color } },
					React.createElement(TdOperateComponent, { operates: this.props.operates }),
					tds
				);
			}
	...
	var BodyTableComponent = React.createClass({
		displayName: 'BodyTableComponent',
		...
		render: function render() {
			...
			if (this.props.rows == null) {
				...
				this.props.rows.forEach(function (row) {
					rows.push(React.createElement(TableCommonRowComponent, { row: row, operates: this.props.operates, indexs: this.props.indexs }));
				}.bind(this));
			}

			return React.createElement(
				'div',
				{ border: '1', style: { height: '380px', width: 'auto', overflow: 'auto', 'display': 'block' } },
				React.createElement(
					'table',
					{ className: 'table  table-bordered ', id: 'body_table_list', 'data-body': 'body' },
					React.createElement(
						'thead',
						{ style: { width: 'auto' } },
						React.createElement(TableHeadRowComponent, { heads: this.props.heads })
					),
					React.createElement(
						'tbody',
						null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainMenu = React.createClass({
		...
		componentWillMount: function componentWillMount() {
			/*	var dom =  ReactDOM.findDOMNode(this.refs.menu);
	  	$.ajax({
	      		url:'?controller=UserController&act=getUserMenuRights',
	      		dataType:'json',
	      		type:'POST',
	      		async:false,  
	      		success:function(data){
	  	...
	  	$(dom).find("li").each(function(){
			...
			/*$("a[data-mold='menu']").each(function(){
	  	var require = $(this).data("require");
	  	alert(require);
	  });*/

			/*	$("li[data-require]").each(function(){
	  		var require = $(this).data("require");
	  		alert(require);
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"button",
						{ className: "navbar-toggle", type: "button", "data-toggle": "collapse", "data-target": ".navbar-responsive-collapse" },
						React.createElement(
							"span",
							{ className: "sr-only" },
							"Toggle Navigation"
				...
				React.createElement(
					"nav",
					{ className: "collapse navbar-collapse navbar-responsive-collapse", role: "navigation" },
					React.createElement(
						"div",
						null,
						React.createElement(
							"ul",
							{ className: "nav navbar-nav ", ref: "menu", id: "menu_ul" },
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "customer_intention" },
								React.createElement(
									"a",
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "customer_intention_new" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerNew" },
											"新建客户"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_intention_pool" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerIntentionList" },
											"意向客户池"
										)
									),
									React.createElement(
										...
										React.createElement(
											"a",
											{ "data-require": "customer_intention_visit_list", href: "?controller=CustomerProcessController&act=customerVisitList" },
											"待回访列表"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "customer_deal" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"跟进客户区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "customer_deal_new" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerNew&type=1" },
											"新建客户"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_deal_pool" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerDealList" },
											"跟进客户池"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_deal_visit_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerVisitList" },
											"待回访列表"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_deal_grap_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerGrapList" },
											"抢单列表"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_deal_pre_sign_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerPreSignList" },
											"预签单列表"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "customer_sucess" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"客户成交区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "customer_success_pool" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerSuccessList" },
											"成交客户池"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_sucess_contract_list" },
										React.createElement(
											"a",
											{ href: "?controller=ContractController&act=contractList" },
											"客户合同池"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "mobile_success_function_change_list" },
										React.createElement(
											"a",
											{ href: "?controller=MobileController&act=customerFunctionChangeList" },
											"客户切换功能分析"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "mobile_success_function_suite_list" },
										React.createElement(
											"a",
											{ href: "?controller=MobileController&act=customerFunctionSuiteList" },
											"功能适用场景分析"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_sucess_contract_payment_list" },
										React.createElement(
											"a",
											{ href: "?controller=ContractController&act=contractPaymentList" },
											"收款管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_sucess_contract_cost_list" },
										React.createElement(
											"a",
											{ href: "?controller=ContractController&act=contractCostList" },
											"成本管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_sucess_contract_payment_urge_list" },
										React.createElement(
											"a",
											{ href: "?controller=ContractController&act=contractpaymentUrgeList" },
											"催款管理"
										)
									),
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_success_function" },
										React.createElement(
											"a",
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_success_function_pool_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerProcessController&act=customerFunctionPoolList" },
													"亮点功能池"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_success_function_change_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerProcessController&act=customerFunctionChangeList" },
													"客户切换功能分析"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_success_function_suite_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerProcessController&act=customerFunctionSuiteList" },
													"功能适用场景分析"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_sucess_visit_list" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"客户回访"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_visit_bacth_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerProcessController&act=customerBackBacthList" },
													"批次管理"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_visit_process_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerProcessController&act=customerVisitProcessList" },
													"进行回访"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_visit_fail_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerProcessController&act=customerVisitFailList" },
													"回访失败"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_sucess_server_fee" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"服务费"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_manage" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFeeManage" },
													"服务费管理"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_urge" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFeeUrge" },
													"服务费催款"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_al_rec" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFeeAlRec" },
													"已收服务费"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_run_off" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFeeRunOff" },
													"已流失客户"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_chg_log" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFeeChgLog" },
													"手工修改服务费记录"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_static_per" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFreeStaticPer" },
													"当月服务费统计"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_server_fee_static_all" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractServerFreeStaticAll" },
													"总体服务费分布"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_sucess_document" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"客户档案"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_document_new" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=customerDocumentNewList" },
													"新建档案"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_document_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=customerDocumentList" },
													"档案列表"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_document_hign_level" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=customerDocumentHignList" },
													"客户案例"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_link_manage_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=customerLinkManageList" },
													"客户联系人备份"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_sucess_manage" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"客户管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_manage_query" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=customerQueryList" },
													"客户查询"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_manage_update" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=customerUpdateList" },
													"客户升级"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_sucess_rebate" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"返款管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_rebate_new" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerRebateController&act=customerRebateNew" },
													"新建返款"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_sucess_rebate_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerRebateController&act=customerRebateList" },
													"返款列表"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_success_invoice_manage" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"发票管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_success_invoice_new" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerInvoiceController&act=customerInvoiceNew" },
													"新建发票"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_success_invoice_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerInvoiceController&act=customerInvoiceList" },
													"发票列表"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "customer_success_expense" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"差旅报销"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "customer_success_expense_manage_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerOperationController&act=customerExpenseManageList" },
													"报销管理"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_success_expense_check_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerOperationController&act=customerExpenseCheckList" },
													"报销审核"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ "data-require": "customer_success_refund" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerRefundList" },
											"客户退款"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_success_apply_api_warehouse" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerController&act=customerApiWarehouseList" },
											"申请API/仓储对接列表"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_success_change_price" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerController&act=customerChangePriceList" },
											"改价管理"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "implement_work" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"实施工单区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "implement_work_check_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerWorkCheckList" },
											"工单审核"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "implement_work_assign_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerWorkAssignList" },
											"下工单"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "implement_work_manage_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerProcessController&act=customerWorkManageList" },
											"工单管理"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "finance_area" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"财务专区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "finance_payment_area" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"收款管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "finance_area_payment_confirm_list" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractPaymentConfirmList" },
													"到款确认"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_payment_daily_confirm_list" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractPaymentDailyList" },
													"收款报表"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_payment_al_confirm_list" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractPaymentAlConfirmList" },
													"已确认收款单"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "finance_cost_area" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"成本管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "finance_area_cost_confirm_list" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractCostConfirmList" },
													"成本确认"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_al_cost_confirm_list" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractCostAlConfirmList" },
													"已确认成本"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "finance_back_rebate_area" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"返款"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "finance_area_back_rebate_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerRebateController&act=customerRebateBackConfirmList" },
													"待回款确认"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_send_rebate_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerRebateController&act=customerRebateSendConfirmList" },
													"待返款确认"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_al_send_rebate_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerRebateController&act=customerRebateAlList" },
													"已返款列表"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "finance_invoice_area" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"发票"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "finance_area_invoice_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerInvoiceController&act=customerInvoiceConfirmList" },
													"开发票确认"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_invoice_open_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerInvoiceController&act=invoiceOpenConfirmList" },
													"待邮寄列表"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_invoice_al_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerInvoiceController&act=customerInvoiceAlConfirmList" },
													"已邮寄列表"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ "data-require": "finance_area_al_contract_manage_list" },
										React.createElement(
											"a",
											{ href: "?controller=ContractController&act=contractManageList" },
											"合同管理"
										)
									),
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "finance_refund_area" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"退款管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "finance_area_refund_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractController&act=contractRefundConfirm" },
													"退款确认"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "finance_area_al_refund_confirm" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractAlRefundConfirm" },
													"已确认退款单"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ "data-require": "finance_area_financial_state" },
										React.createElement(
											"a",
											{ href: "?controller=ContractController&act=contractFinancialState" },
											"财务报表"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "personal_area" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"人事专区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "personal_area_user_manage" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userManageList" },
											"员工管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "personal_area_contract_manage" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userContractList" },
											"劳动合同"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "personal_area_dept_manage" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=deptManageList" },
											"部门管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "personal_area_position_manage" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=positionManageList" },
											"职位管理"
										)
									),
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "personal_area_fixed_asset" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"固定资产"
										...
										React.createElement(
											...
											React.createElement(
												...
												React.createElement(
													"a",
													{ href: "?controller=UserController&act=fixedAssetManageList" },
													"公司资产"
												)
											),
											React.createElement(
												...
												React.createElement(
													"a",
													{ href: "?controller=UserController&act=fixedAssetPersonalManageList" },
													"个人资产"
												)
											)
										)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "operation_area" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"运维专区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "operation_area_open_stock_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerOperationController&act=customerOpenList" },
											"开库"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "operation_area_pda_manage_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerOperationController&act=customerPdaManageList" },
											"PDA管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "operation_area_message_recharge_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerOperationController&act=customerMessageRechargeList" },
											"短信充值"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "operation_area_message_manage_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerOperationController&act=customerMessageManageList" },
											"短信管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "operation_area_api_apply_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerController&act=customerApiApplyList" },
											"API对接申请"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "operation_area_warehouse_apply_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerController&act=customerWarehouseApplyList" },
											"仓储对接申请"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "operation_area_user_logs" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userLogs" },
											"系统日志"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "perform_area" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"绩效专区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "perform_area_sale_perform_day" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"销售"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "perform_area_sale_perform_day" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=salePerformList" },
													"销售绩效看板"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_sale_perform_month" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=salePerformMonthList" },
													"销售月绩效"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_sale_achievement" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=saleAchievementList" },
													"销售业绩看板"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "sale_single_effect_analysis" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=saleSingleEffectAnalysisList" },
													"抢单效果分析"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_undeal_customer" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=customerUndealManageList" },
													"长期未跟进客户"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_payment_list" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=salePerformPaymentList" },
													"收款报表"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_contract_uncheck" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=salePerformContractUncheckList" },
													"合同长期未终审客户"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "contract_no_receive_payment" },
												React.createElement(
													"a",
													{ href: "?controller=ContractController&act=contractNoReceivePayment" },
													"长期未收款合同"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_give_manage_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=CustomerGiveManageList" },
													"赠送记录"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "customer_day_success_list" },
												React.createElement(
													"a",
													{ href: "?controller=CustomerController&act=CustomerDaySuccessList" },
													"每日成交客户"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_sale_deal_unusual_price" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=saleDealUnusualPriceList" },
													"价格异常成交记录"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_sale_api_list" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=saleApiList" },
													"API接口开放记录"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_sale_warehouse_list" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=saleWarehouseList" },
													"仓储接口开放记录"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "perform_area_imp_manage_list" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"实施"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "perform_area_imp_unusual_list" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=impUnusualManageList" },
													"实施异常客户"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "perform_area_imp_perform_list" },
												React.createElement(
													"a",
													{ href: "?controller=UserPerformController&act=impPerformList" },
													"实施看板"
												)
											)
										)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "customer_question" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"问题专区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "customer_success_question_new" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerQuestionController&act=customerQuestionNew" },
											"新建问题"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_success_question_query" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerQuestionController&act=customerQuestionList" },
											"问题管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_success_question_module" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerQuestionController&act=customerQuestionModule" },
											"问题模块"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_question_document_list" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerQuestionController&act=customerQuestionDocumentList" },
											"归档管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "customer_question_statistic" },
										React.createElement(
											"a",
											{ href: "?controller=CustomerQuestionController&act=customerQuestionStatistic" },
											"问题统计"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "user_week_work_list" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userWeekWork" },
											"研发值班登记"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "setting_area" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"设置专区"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "setting_area_user_rights_list" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userList&is_delete=0" },
											"权限设置"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "setting_area_sale_customer_num" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=saleCustomerNumList&is_delete=0" },
											"销售客户数量权限"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "user_compete_manage_list" },
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userCompeteManageList" },
											"竞争对手管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "setting_area_send_email" },
										React.createElement(
											"a",
											{ href: "?controller=SysSettingController&act=sysSendEmail" },
											"系统邮箱/消息设置"
										)
									),
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "setting_type_manage_list" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"类型管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "setting_payment_cost_type_list" },
												React.createElement(
													"a",
													{ href: "?controller=SysSettingController&act=sysPaymentAndCostTypeList" },
													"收款类型/成本类型"
												)
											)
										)
									...
									React.createElement(
										"li",
										{ "data-require": "setting_area_version_manage" },
										React.createElement(
											"a",
											{ href: "?controller=SysSettingController&act=sysVersionManageList" },
											"版本管理"
										)
									)
								)
							...
							React.createElement(
								"li",
								{ className: "dropdown", "data-require": "user_area" },
								React.createElement(
									"a",
									{ className: "dropdown-toggle", "data-toggle": "dropdown", href: "#" },
									"用户中心"
								...
								React.createElement(
									...
									React.createElement(
										"li",
										{ "data-require": "user_flag_manage_list" },
										React.createElement(
											"a",
											{ href: "?controller=UserFlagController&act=UserFlagManageList" },
											"标记管理"
										)
									),
									React.createElement(
										"li",
										{ "data-require": "user_area_task_list" },
										React.createElement(
											"a",
											{ href: "?controller=TaskController&act=userTaskList" },
											"任务中心"
										)
									),
									React.createElement(
										"li",
										{ className: "dropdown-submenu", "data-require": "user_area_daily_list" },
										React.createElement(
											"a",
											{ className: "dropdown-toggle", "data-toggle": "dropdown" },
											"日程管理"
										...
										React.createElement(
											...
											React.createElement(
												"li",
												{ "data-require": "user_area_daily_list" },
												React.createElement(
													"a",
													{ href: "?controller=UserController&act=userDailyList" },
													"日程中心"
												)
											),
											React.createElement(
												"li",
												{ "data-require": "user_area_daily_list_director_check" },
												React.createElement(
													"a",
													{ href: "?controller=UserController&act=userDailyCheckList" },
													"总监审核"
												)
											)
										)
									...
									React.createElement(
										...
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userPersonalList" },
											"个人中心"
										)
									),
									React.createElement(
										...
										React.createElement(
											"a",
											{ href: "?controller=CustomerController&act=softUpdateList" },
											"升级日志"
										)
									),
									React.createElement(
										...
										React.createElement(
											"a",
											{ href: "?controller=UserController&act=userLoginOut" },
											"退出"
										)
									)
								)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TurnPageComponent = React.createClass({
		...
		onClickTurnPage: function onClickTurnPage() {
			var type = 5;
			this.handlePage(type);
		},
		handlePage: function handlePage(type) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					null,
					" 共",
					this.props.page.total,
					"条记录 当前第",
					this.props.page.cur_page,
					"页 共",
					this.props.page.total_page,
					"页"
				),
				React.createElement(
					"div",
					...
					React.createElement("input", { type: "text", ref: "input_page" }),
					React.createElement(
						"button",
						{ onClick: this.onClickTurnPage },
						"跳转"
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TabComponent = React.createClass({
		...
		onClickTabs: function onClickTabs() {
		...
		render: function render() {
			...
			this.props.tabs.forEach(function (result) {
				if (count == 1) {
					rows.push(React.createElement(
						"li",
						{ className: "active", "data-url": result.url },
						React.createElement(
							"a",
							{ url: "url", href: "tab_crm", "data-toggle": "tab" },
							result.name
						)
					));
				} else {
			...
			return React.createElement(
				"div",
				{ id: "tab_page_div", className: "ui-widget-content", style: { 'height': '20%' } },
				React.createElement(
					"ul",
					{ className: "nav nav-tabs", id: "tab_ul", ref: "tab_ul" },
					rows
				),
				React.createElement(
					"div",
					{ className: "tab-content", style: { width: 'auto', height: '80%', overflow: 'auto' } },
					React.createElement(
						"div",
						{ className: "tab-pane fade in active ", id: "tab_crm" },
						React.createElement("table", { className: "table table-hover ", id: "tab_crm_table" })
					)
				)
			);
		}
