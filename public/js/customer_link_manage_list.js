...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "状态", "联系人", "联系人电话", "联系人职位", "修改时间", "创建时间"];

	var indexs = ["company_name", "shop_name", "status", "link_man", "link_tel", "link_position", "modified", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "btn_chg", "target": "#customer_link_chg", "name": "" }, { "title": "失效", "class2": "btn_cancel", "target": "", "name": "" }, { "title": "恢复", "class2": "btn_recovery", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerLinkManageList";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, " ?controller=CustomerProcessController&act=customerLinkManageList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, " ?controller=CustomerProcessController&act=customerLinkManageList&" + page_data);
