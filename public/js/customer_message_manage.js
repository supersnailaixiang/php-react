...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["类型", "状态", "公司名称", "店铺名称", "卖家账号", "条数", "金额", "单价", "备注", "创建人", "创建时间"];

	var indexs = ["type", "status", "company_name", "shop_name", "seller_account", "num", "amount", "price", "remark", "creator_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerOperationController&act=getCustomerMessageManageList";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#customer_message_buy' },
					'购买短信'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#customer_message_send' },
					'赠送短信'
				),
				React.createElement(
					'button',
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerOperationController&act=customerMessageManageList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerOperationController&act=customerMessageManageList&" + page_data);
