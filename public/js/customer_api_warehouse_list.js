...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["类型", "状态", "公司名称", "店铺名称", "卖家账号", "正式/测试", "客户负责人", "负责人联系方式", "负责人邮箱", "第三方系统名称", "对接类型", "对接客户类型", "对接业务", "审核备注", "创建人", "创建时间"];

	var indexs = ["type", "status", "company_name", "shop_name", "seller_account", "is_formal", "link_man", "link_tel", "link_email", "other_system_name", "other_type", "api_customer_type", "other_business", "remark", "user_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerApiWarehouseList";

	var tabs = [{ name: "操作日志", url: "?controller=CustomerController&act=customerApiWarehouseLogByID" }];
	...
	var TableCommonRowComponent = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'tr',
				{ onClick: this.onClickRow, 'data-id': this.props.row.rec_id, 'data-seller_account': this.props.row.seller_account, 'data-type': this.props.row.doc_type },
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#customer_api_warehouse_chg' },
					'修改'
				),
				React.createElement(
					'button',
					{ id: 'api_warehouse_submit' },
					'重新递交'
				)
			);
		}
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerController&act=customerApiWarehouseList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerController&act=customerApiWarehouseList&" + page_data);
