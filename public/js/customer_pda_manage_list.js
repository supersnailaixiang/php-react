...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["类型", "状态", "合同状态", "公司名称", "店铺名称", "买家账号", "数量", "销售1", "销售2", "创建人", "所属大区", "创建时间"];

	var indexs = ["pda_type", "pda_status", "contract_status", "company_name", "shop_name", "seller_account", "num", "sale_user_name_1", "sale_user_name_1", "creator_name", "region_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerOperationController&act=getCustomerPdaManageList";

	var tabs = [
		/*{name:"日志",url:"?controller=CustomerProcessController&act=customerLogList"},
	 {name:"事件",url:"?controller=EventController&act=getEventListByID"},
	 {name:"任务",url:"?controller=TaskController&act=getTaskListByID"}*/
	];
