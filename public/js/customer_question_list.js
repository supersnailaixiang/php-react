...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["问题ID", "归档号", "问题标题", "状态", "所属产品", "父模块", "子模块", "问题类型", "版本号", "单据编号", "卖家账号", "接收人", "转接负责1", "解决人", "创建者", "响应时间(分钟)", "解决时间", "创建时间"];
	var indexs = ["question_id", "doc_id", "title", "question_status", "product_name", "module_name", "sub_name", "type_name", "version_num", "receipts", "seller_account", "receive_name", "name4", "resolve_name", "creator_name", "response_time", "resolve_date", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['question_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改问题", "class2": "btn_update", "target": "#question_update_div", "name": "" }, { "title": "重新递交", "class2": "btn_resend", "target": "", "name": "" }, { "title": "提问人确认问题是否解决", "class2": "btn_confirm", "target": "#questioner_confirm", "name": "" }, { "title": "查看私密信息", "class2": "btn_check", "target": "#question_information", "name": "" }, { "title": "取消问题", "class2": "btn_cancel" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerQuestionController&act=getCustomerQuestionList";

	var tabs = [{ name: "日志", url: "?controller=CustomerQuestionController&act=customerQuestionLogByID" }];
	...
	var SelectComponent = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'select',
	      { className: 'selectpicker ', key: this.props.name, onChange: this.onChangeValue, multiple: this.props.multiple, 'data-live-search': 'true', ref: this.props.name, name: this.props.name, id: this.props.id },
	      rows
	    );
	  }
	});
	var SearchFormComponent = React.createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    var question_status = $(dom).find("[id='question_status']").val();
	    data += "&question_status=" + question_status;
	    $.each(search_data, function (key, value) {
	      data += "&" + key + "=" + value;
	    });

	    if ($(dom).attr('data-reset') == "1") {
	      data = '';
	      search_data = Object();
	      $(dom).attr('data-reset', 0);
	    }
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { ref: this.props.name, style: { padding: '5px' }, id: 'search_form', key: 'serach_form_list' },
	      React.createElement(
	        'table',
	        null,
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'select',
	              { id: 'question_status', className: 'selectpicker', multiple: true, 'data-live-search': 'true' },
	              React.createElement(
	                'option',
	                { value: '0' },
	                '全部'
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=7,9,12', name: 'principal' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserAll', name: 'creator' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'question_id' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'seller_account' })
	          ),
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'button', style: { width: '80px' }, id: 'search_btn', onClick: this.handleSubmit, value: '查找' })
	          ),
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'button', style: { width: '80px' }, id: 'search_reset', onClick: this.handleSubmit, value: '重置' })
	          ),
	          React.createElement(
	            'td',
	            null,
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=DictDataController&act=getDictData&type=18', name: 'product_type', id: 'search_product' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'select',
	              { name: 'submodule_id', id: 'search_sub_id' },
	              React.createElement(
	                'option',
	                { value: '0' },
	                '全部'
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=CustomerQuestionController&act=customerQuestionType&status=1&type=1', name: 'question_type' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserAll', name: 'resolve_man' })
	          ),
	          React.createElement(
	            'td',
	            null,
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getDepartment', name: 'dept_id', id: 'dept_id' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('select', { name: 'region_id', id: 'region_id' })
	          )
	        )
	      )
	    );
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_question_type_check' },
	        '查看问题类型'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_question_type_add' },
	        '添加问题类型'
	      ),
	      React.createElement(
	        'button',
	        { id: 'customer_question_receive' },
	        '接收问题'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_question_check' },
	        '查看问题'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_resolve_add' },
	        '添加解决方案'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_chg' },
	        '转接问题'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_end' },
	        '终止问题'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_reject' },
	        '驳回问题'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#set_checker' },
	        '设置审核人'
	      ),
	      React.createElement(
	        'button',
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_document_list' },
	        '归档'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#update_question_type' },
	        '修改问题类型'
	      ),
	      React.createElement(
	        'a',
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#set_export_man' },
	        '设置导出人'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_hang_list' },
	        '挂起'
	      )
	    );
	  }
	});
	var CustomerQuestionList = React.createClass({
	  displayName: 'CustomerQuestionList',
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerQuestionController&act=customerQuestionList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerQuestionController&act=customerQuestionList&" + page_data);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(SearchFormComponent, { onSearchSubmit: this.onSearchSubmit, name: 'search_form' }),
	...
	ReactDOM.render(React.createElement(CustomerQuestionList, { url: url }), document.getElementById('content_question'));
