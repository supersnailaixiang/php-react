...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["平台", "用户名", "状态", "年份", "改价单类型", "创建人", "改价人", "买家账号", "修改时间", "创建时间"];

	var indexs = ["platform_id", "member_name", "status", "year", "price_type", "creator_name", "changeor_name", "seller_account", "modified", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "取消", "class2": "btn_cancel", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerChangePriceList";

	var tabs = [{ name: "日志", url: "?controller=CustomerController&act=customerChangePriceLogList" }];
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'member_name' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=3,4', name: 'creator' })
	          ),
	          React.createElement(
	            'td',
	            null,
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'date', name: 'start_date' })
	          ),
	          React.createElement(
	            'td',
	            null,
	...
	var ModalComponent = React.createClass({
	  ...
	  changeReject: function changeReject() {
	    var rec_id = $("#body_table_list ").find(".tr_selected").attr("data-id");
	    var remark = $("#customer_reject_form").find("[name='remark']").val();
	    var url = "?controller=CustomerController&act=customerChangePriceReject";
	    ...
	    if (is_success == 1) {
	      ...
	      alert("驳回成功");
	      $("#customer_reject_list").modal('hide');
	    }
	  },
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'modal fade', id: 'customer_reject_list', tabindex: '-1', role: 'dialog',
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'modal-body', style: { width: 'auto' }, id: 'modal_div_list' },
	            React.createElement(
	              'form',
	              { id: 'customer_reject_form' },
	              '驳回原因;',
	              React.createElement('textarea', { name: 'remark', style: { width: '200px', height: '100px' } })
	            )
	          ),
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-primary', onClick: this.changeReject },
	              '驳回'
	            )
	          )
	        )
	...
	var SearchButton = React.createClass({
	  ...
	  changePrice: function changePrice() {
	    ...
	    var url = "?controller=CustomerController&act=customerChangePrice";
	    //      var assign_tel_sale_user_id = search_data['assign_tel_sale_user_id'];
	    // var url ="?controller=CustomerProcessController&act=customerAssignTel";
	    if (rec_id == "") {
	      alert("请选中要改价的单据");
	    ...
	    is_success = 0;
	    $.ajaxSettings.async = false;
	    $.post(url, { rec_id: rec_id }, function (result) {
	      if (result == true) {
	  ...
	  changePriceSubmit: function changePriceSubmit() {
	    var rec_id = $("#body_table_list ").find(".tr_selected").attr("data-id");

	    var url = "?controller=CustomerController&act=customerChangePriceSubmit";
	    //      var assign_tel_sale_user_id = search_data['assign_tel_sale_user_id'];
	    // var url ="?controller=CustomerProcessController&act=customerAssignTel";
	    if (rec_id == "") {
	      alert("请选中要改价的单据");
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { href: '?controller=CustomerController&act=customerChangePriceNew' },
	        React.createElement(
	          'button',
	          null,
	          '新建'
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_chg_list' },
	        '修改'
	      ),
	      React.createElement(
	        'button',
	      ...
	      React.createElement(
	        'button',
	        { onClick: this.changePriceSubmit },
	        '重新递交'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_change_price_receive' },
	        '修改改价人'
	      )
	    );
	  }
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        $("#seller_accounts").val(result.seller_accounts);
	      }.bind(this),
	      error: function (xhr, status, err) {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(SearchButton, { handleSearch: this.handleSearch }),
	      ...
	      React.createElement(ModalComponent, { handleSearch: this.handleSearch })
	    );
	  }
	});
