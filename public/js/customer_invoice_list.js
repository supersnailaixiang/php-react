...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["订单编号", "卖家账号", "状态", "公司名称", "联系人", "发票金额", "发票类型", "邮寄类型", "创建人", "确认时间", "邮寄时间", "创建时间"];
	var indexs = ["trade_no", "seller_account", "invoice_status", "company_name", "link_man", "invoice_amount", "invoice_type", "send_type", "creator_name", "confirm_date", "invoice_time", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerInvoiceController&act=getCustomerInvoiceList";
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#invoice_chg_List' },
	        '修改'
	      ),
	      React.createElement(
	        'button',
	      ...
	      React.createElement(
	        'a',
	        { href: '', id: 'btn_check_courier', target: '_blank' },
	        React.createElement(
	          'button',
	          null,
	          '查看快递'
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerInvoiceController&act=customerInvoiceList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerInvoiceController&act=customerInvoiceList&" + page_data);
