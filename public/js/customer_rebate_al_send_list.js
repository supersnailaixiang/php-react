...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["平台", "订单编号", "状态", "用户名", "联系人", "客户名称", "卖家账号", "所属银行", "开户行", "开户名", "银行账号", "订购日期", "返款金额", "备注", "创建人", "回款时间", "返款时间", "修改时间", "创建时间"];
	var indexs = ["platform_id", "trade_no", "rebate_status", "member_name", "link_man", "customer_name", "seller_account", "bank", "open_bank", "open_name", "bank_account", "order_date", "rebate_amount", "remark", "creator_name", "back_check_time", "send_check_time", "modified", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerRebateController&act=getCustomerRebateAlList";
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerRebateController&act=customerRebateAlList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerRebateController&act=customerRebateAlList&" + page_data);
