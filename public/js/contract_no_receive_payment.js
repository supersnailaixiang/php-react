...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "销售", "合同金额", "收款预期"];

	var indexs = ["company_name", "shop_name", "sale_name", "contract_amount", "payment_detail"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractNoReceivePayment";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#contract_payment_setting' },
					'设置'
				)
			);
		}
