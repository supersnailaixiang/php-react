...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["日期", "应续费客户数", "服务费总金额"];

	var indexs = ["month", "all_collect", "collect_amount"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractServerFreeStatic&type=all";
