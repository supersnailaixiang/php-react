...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["排名", "销售", "绩效", "提成金额", "回款金额", "合同超过20万金额", "自寻新客户含有软件", "自寻客户不含老软件", "公司分配含有老软件", "公司分配不含有老软件", "回款绩效", "成本金额", "成本绩效", "退款金额", "退款绩效", "统计时间"];

	var indexs = ["rank_id", "sales_man", "amount", "percent_amount", "payment_amount", "large_contract_amount", "old_soft_amount_self", "amount_self", "assign_old_soft_amount", "assign_amount", "payment_percent_amount", "cost_amount", "cost_percent_amount", "refund_amount", "refund_percent_amount", "perform_date"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getSalePerformList";
	...
	var SelectComponent = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'select',
				_defineProperty({ id: 'sale_user_id', className: 'selectpicker ', key: this.props.name, onChange: this.onChangeValue, multiple: this.props.multiple, 'data-live-search': 'true', ref: this.props.name }, 'id', 'test'),
				rows
			);
		}
	});
	...
	var CustomerIntentionList = React.createClass({
		...
		getInitialState: function getInitialState() {
			return { rows: table_rows, search_data: '' };
		},
		onSearchSubmit: function onSearchSubmit(data) {
			...
			$.ajax({
				...
				success: function (result) {
					...
					this.setState({ rows: result, search_data: data });
				}.bind(this),
				error: function (xhr, status, err) {
		...
		handleTablePage: function handleTablePage(page) {
			var page_data = this.state.search_data;
