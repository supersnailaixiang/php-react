...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["客户级别", "公司名称", "店铺名称", "卖家账号", "平均日单量", "所属行业", "所属类目", "所在省", "所在市", "店铺个数"];
	var indexs = ["implement_customer_level", "company_name", "shop_name", "seller_account", "average_order_num", "industry_name", "cate_name", "province_name", "city_name", "shops_num"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "归档", "class2": "document_place", "target": "#document_place_list", "name": "" }, { "title": "结束归档", "class2": "end_document", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerDocumentNewList";

	var tabs = [{ name: "客户档案", url: "?controller=CustomerController&act=customerDocumentBySellerID" }];
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerController&act=customerDocumentNewList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerController&act=customerDocumentNewList&" + page_data);
