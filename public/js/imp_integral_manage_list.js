...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexs = ["region_name", "user_name", "imp_grade"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getImpIntegralManageList";

	var tabs = [{ name: "积分来源", url: "?controller=UserPerformController&act=getImpIntegralManageListByUserID" }];
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=DictDataController&act=getDictData&type=3&index=3', name: 'region_id' })
						),
						React.createElement(
							'td',
							null,
