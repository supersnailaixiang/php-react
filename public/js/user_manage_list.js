...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["编号", "考勤机编号", "姓名", "性别", "部门", "职位", "工作地址", "入职日期", "试用期", "转正日期", "紧急联络人", "出生日期", "生日类型", "生日日期", "年龄", "民族", "婚姻状况", "户籍地址", "户口类型", "邮编", "最高学历", "毕业院校", "专业", "职称", "证书编号", "工行卡号", "开户行", "执行劳工合同", "合同签署日期", "合同到期日期", "保险", "医保存折", "医保卡", "备注", "固定资产", "所在大区", "是否离职", "离职日期"];

	var indexs = ["user_no", "check_no", "user_name", "sex", "dept_name", "position_name", "work_address", "entry_date", "probation", "formal_date", "emergency_contact_person", "birth_date", "birthday_type", "birthday_date", "age", "nation", "marry_status", "register_address", "register_type", "zip_code", "highest_education", "graduate_school", "profession_major", "profession_rank", "certificate_no", "card_no", "bank_name", "contract_num", "contract_sign_date", "contract_end_date", "insurance_date", "medicare_passbook", "medicare_card", "remark", "user_asset", "region_name", "is_delete", "demission_date"]; //相当于sql的表头

	var table_rows = result;
	var user_flags = flags;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改员工", "class2": "btn_chg", "target": "#user_info_chg", "name": "" }, { "title": "修改员工密码", "class2": "add_event", "target": "#user_pwd_chg", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=UserController&act=getUserManageList";

	var tabs = [{ name: "日志", url: "?controller=UserController&act=getUserManageLogs" }];
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getDepartment', name: 'dept_id' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'user_name' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'graduate_school' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'profession_major' })
						),
						React.createElement(
							'td',
							null,
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ id: 'btn_del_image_user' },
					'删除员工电子信息'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#user_contract_add_list' },
					'添加合同'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#user_add_list' },
					'添加员工'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#btn_back_tel' },
					'离职员工'
				),
				React.createElement(
					'button',
					{ id: 'user_expense_account_add_list' },
					'离职恢复'
				),
				'设置标记:',
				React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#user_set_reminder' },
					'设置提醒人'
				),
				React.createElement(
					'a',
				...
				React.createElement(
					'a',
					{ href: '?controller=UserController&act=userSalarySend' },
					' ',
					React.createElement(
						'button',
						{ id: 'btn_import' },
