...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["所属产品", "父模块名", "子模块名", "主管", "研发负责1", "研发负责2", "研发负责3", "创建人", "修改时间", "创建时间"];
	var indexs = ["product_type", "main_name", "sub_name", "satrap_name", "principal1_name", "principal2_name", "principal3_name", "creator_name", "modified", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['submodule_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改子模块", "class2": "btn_update", "target": "#question_update_module", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerQuestionController&act=getcustomerQuestionModule";

	var tabs = [{ name: "日志", url: "?controller=CustomerQuestionController&act=questionModuleLog" }];
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=7,9,12', name: 'principal', id: 'principal' })
	          ),
	          React.createElement(
	            'td',
	            null,
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#add_product_type' },
	        '添加产品类型'
	      ),
	      React.createElement(
	        'button',
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#add_main_module' },
	        '添加父模块'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#main_module' },
	        '查看父模块'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#add_submodule' },
	        '添加子模块'
	      )
	    );
	  }
	});
	var CustomerQuestionModule = React.createClass({
	  displayName: 'CustomerQuestionModule',
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerQuestionController&act=customerQuestionModule&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerQuestionController&act=customerQuestionModule&" + page_data);
	...
	ReactDOM.render(React.createElement(CustomerQuestionModule, { url: url }), document.getElementById('content'));
