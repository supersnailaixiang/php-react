...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["卖家账号", "公司名称", "店铺名称", "批次", "销售", "实施", "本次回访人", "回访时间", "实施大区"];

	var indexs = ["seller_account", "company_name", "shop_name", "bacth_name", "sale_man", "imp_man", "visitor_name", "visit_date", "region_name"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "添加事件", "class2": "add_event", "target": "#add_event_list", "name": "" }, { "title": "添加任务", "class2": "add_task", "target": "#add_task_list", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getcustomerVisitFailList";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerVisitFailList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerVisitFailList&" + page_data);
