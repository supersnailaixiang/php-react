...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "实施工程师", "协助工程师", "实施监督", "销售1", "卖家账号", "异常原因", "虚拟项目个数", "下单时间", "分配时间", "联系客户时间", "实施暂停时间", "重新实施时间", "离开现场时间", "提交结项时间", "公司结项时间"];

	var indexs = ["company_name", "shop_name", "imp_user_id", "imp_user_id2", "imp_user_id3", "sale_man", "seller_account", "unusual_info", "virtual_project_num", "work_order_time", "assign_work_time", "link_customer_time", "imp_stop_time1", "imp_stop_time2", "leave_scene_time", "submit_project_time", "end_company_project_time"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getImpUnusualManageList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=3', name: 'imps' })
						),
						React.createElement(
							'td',
							null,
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#imp_unuausl_setting' },
					'设置'
				)
			);
		}
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=UserPerformController&act=impUnusualManageList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=UserPerformController&act=impUnusualManageList&" + page_data);
