...
/***/ function(module, exports, __webpack_require__) {
	...
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "btn_chg", "target": "#customer_function_chg", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerFunctionPoolList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'func_name' }),
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: true, url: '?controller=DictDataController&act=getDictData&type=10', name: 'version_type', id: 'version_type' })
						),
						React.createElement(
							'td',
							null,
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerFunctionPoolList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerFunctionPoolList&" + page_data);
