...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["订单编号", "状态", "公司名称", "卖家账号", "发票类型", "邮寄类型", "发票金额", "一般纳税人", "纳税人识别号", "开户行及帐号", "联系人", "联系电话", "地址电话", "邮寄地址", "邮箱", "结算单号", "订购时间", "备注", "创建人", "创建时间"];
	var indexs = ["trade_no", "invoice_status", "company_name", "seller_account", "invoice_type", "send_type", "invoice_amount", "is_general_taxpayer", "taxpayer_number", "open_bank_account", "link_man", "link_tel", "registered_address", "mailint_address", "link_email", "final_no", "order_date", "remark", "creator_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerInvoiceController&act=getCustomerInvoiceConfirmList";

	var tabs = [{ name: "日志", url: "?controller=CustomerInvoiceController&act=getCustomerInvoiceLogByID" }];
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'trade_no' })
	          ),
	          React.createElement(
	            'td',
	            null,
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'final_no' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            ...
	            React.createElement('input', { type: 'date', name: 'end_dtae' })
	          )
	        )
	      )
	    );
	...
	var BodyTableComponent = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { style: { width: 'auto', height: '380px', overflow: 'auto', 'display': 'block' }, border: '1' },
	      React.createElement(
	        'table',
	        { className: 'table   table-bordered ', id: 'body_table_list', 'data-body': 'body_double' },
	        React.createElement(
	          'thead',
	          { style: { width: 'auto' } },
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_invoice_import_List' },
	        '导入匹配'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_invoice_no_List' },
	        '未匹配'
	      ),
	      React.createElement(
	        'button',
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_cancel_List' },
	        '取消'
	      ),
	      React.createElement(
	        'button',
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, " ?controller=CustomerInvoiceController&act=customerInvoiceConfirmList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, " ?controller=CustomerInvoiceController&act=getCustomerInvoiceConfirmList&" + page_data);
