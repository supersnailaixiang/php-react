...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["姓名", "职位", "可有客户数", "现有客户数", "创建时间"];

	var indexs = ["user_name", "position_name", "customer_num", "current_customer_num", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [
		//{"title":"修改客户","class2":"btn_chg","target":"#customer_info_chg","name":""},

	]; // 需要输入
	var page_turn = page;
	var url = "?controller=UserController&act=getSaleCustomerNumList&is_delete=0";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#sale_customer_num_set' },
					'设置客户数量'
				)
			);
		}
