...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "批次", "事件类型", "评价1", "评价2", "事件内容", "创建者", "创建时间"];

	var indexs = ["company_name", "bacth_name", "name", "aux_judge1", "aux_judge2", "remark", "user_name", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "btn_chg", "target": "#customer_back_visit_chg", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerBackEventList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=CustomerProcessController&act=getCustomerSuccessBackBacth&type=1', id: 'search_bacth_id', name: 'bacth_id' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=CustomerProcessController&act=getCustomerBackEventType', id: 'search_type_name', name: 'type_name' })
						),
						React.createElement(
							'td',
							null,
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					window.history.pushState(null, null, " ?controller=CustomerProcessController&act=customerBackEventList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, " ?controller=CustomerProcessController&act=customerBackEventList&" + page_data);
