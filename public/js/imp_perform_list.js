...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["实施大区", "实施", "未联系客户", "未上门客户", "实施中", "项目暂停中", "待结项"];

	var indexs = ["region_name", "user_name", "no_contact", "no_come", "in_implimentation", "imp_stop", "wait_end"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getImpPerformList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=3', name: 'imp_id' })
						),
						React.createElement(
							'td',
							null,
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#check_all_project' },
					'查看跟进中项目'
				)
			);
		}
