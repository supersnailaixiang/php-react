...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["编号", "考勤机编号", "姓名", "部门", "职位", "创建时间"];
	var indexs = ["user_no", "check_no", "user_name", "dept_name", "position_name", "created"];

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	// 加一个操作权限判断时候可以做require
	var operates = [{ "title": "test", "class2": "btn_chg", "target": "#myModal" }]; // 需要输入
	//var page = {"total":1,"cur_page":1,"total_page":1};
	var page_turn = page;

	var url = "?controller=UserController&act=getUserList&is_delete=0";
	...
	var SearchFormComponent = React.createClass({
		...
		render: function render() {
			return React.createElement(
				'form',
				{ ref: this.props.name, style: { padding: '5px' } },
				React.createElement(
					'table',
					null,
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserAll', name: 'user_id' })
						),
						React.createElement(
							'td',
							null,
	...
	var UserRightsList = React.createClass({
		displayName: 'UserRightsList',
	...
	ReactDOM.render(React.createElement(UserRightsList, { url: url }), document.getElementById('content'));
