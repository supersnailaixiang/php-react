...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["类型", "标题", "状态", "创建人", "工作量", "完善度", "创建人所属大区", "审核人", "日期", "修改时间", "创建时间"];

	var indexs = ["daily_type", "title", "status", "user_name", "work_grade", "perfect_grade", "region_name", "check_user_name", "user_date", "modified", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserController&act=getUserDailyList";

	var tabs = [{ name: "日志", url: "?controller=UserController&act=getuserDailyLogList" }];
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=3', name: 'users' })
						),
						React.createElement(
							'td',
							null,
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'a',
					{ href: '?conntroller=UserController&act=userDailyNew' },
					React.createElement(
						'button',
						null,
						'新建'
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#user_daily_chg_list' },
					'修改'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#user_daily_check_list' },
					'查看/审核'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#user_daily_reject_list' },
					'驳回'
				),
				React.createElement(
					'button',
					{ id: 'user_daily_submit' },
					'重新递交'
				)
			);
		}
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=UserController&act=userDailyList&" + data);
