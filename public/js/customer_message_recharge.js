...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["类型", "公司名称", "店铺名称", "卖家账号", "条数", "金额", "单价", "创建人", "创建时间"];

	var indexs = ["type", "company_name", "shop_name", "seller_account", "num", "amount", "price", "creator_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerMessageRechargeList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=3', name: 'imp_user_id' })
						),
						React.createElement(
							'td',
							null,
