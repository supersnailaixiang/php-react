...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "提供者", "抢单者", "销售1", "销售2", "销售3", "开启抢单时间", "抢单时间"];

	var indexs = ["company_name", "shop_name", "supplier_name", "grap_name", "sale_name1", "sale_name2", "sale_name3", "open_grap_time", "end_grap_time"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getSaleSingleEffectAnalysisList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=1', name: 'sale_user_id' })
						),
						React.createElement(
							'td',
							null,
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, " ?controller=UserPerformController&act=saleSingleEffectAnalysisList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, " ?controller=UserPerformController&act=saleSingleEffectAnalysisList&" + page_data);
