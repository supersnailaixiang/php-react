...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["日志类型", "公司名称", "店铺名称", "操作人", "备注", "创建时间"];

	var indexs = ["log_type", "company_name", "shop_name", "user_name", "remark", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserController&act=getUserLogs";
