...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["软件", "卖家账号", "状态", "优先级", "当前版本", "期望升级版本", "升级版本", "升级原因", "创建人", "升级时间", "升级人", "取消原因", "创建时间"];

	var indexs = ["software", "seller_account", "status", "priority", "persent_version", "except_update_version", "update_version", "update_reason", "create_name", "update_time", "update_user_name", "cancel_remark", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerUpdateList";
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'update_reason', style: { width: '200px' } })
	          ),
	          React.createElement(
	            'td',
	            null,
	...
	var ModalComponent = React.createClass({
	  ...
	  updateCustomer: function updateCustomer() {
	    ...
	    var url = "?controller=CustomerController&act=customerUpdate";
	    ...
	    if (is_success == 1) {
	      ...
	      alert("升级成功");
	      $("#customer_update").modal('hide');
	    }
	  },
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'modal fade', id: 'customer_update', tabindex: '-1', role: 'dialog',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement('input', { id: 'rec_id', name: 'rec_id', type: 'hidden' }),
	              '卖家账号:',
	              React.createElement('input', { type: 'text', name: 'seller_account', disabled: true }),
	              React.createElement('br', null),
	              '期望版本:',
	              React.createElement('input', { type: 'text', name: 'except_update_version', disabled: true }),
	              React.createElement('br', null),
	              '升级版本:',
	              React.createElement('input', { type: 'text', name: 'update_version', id: 'update_version' }),
	              React.createElement('br', null)
	            )
	          ),
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { type: 'button', className: 'btn btn-primary', onClick: this.updateCustomer },
	              '确定'
	            )
	          )
	        )
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { href: 'http://www.wangdian.cn/wdt/upgrade.php' },
	        React.createElement(
	          'button',
	          null,
	          '2.0软件升级日志'
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_update_add' },
	        '新建'
	      ),
	      React.createElement(
	        'button',
	        { id: 'customer_update_delete' },
	        '删除'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_update_cancel' },
	        '取消'
	      ),
	      React.createElement(
	        'button',
	        { id: 'copy_seller_account', 'data-clipboard-target': 'seller_accounts' },
	        '复制卖家账号'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_update' },
	        '升级'
	      )
	    );
	  }
