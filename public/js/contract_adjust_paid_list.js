...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "合同编号", "调整金额", "状态", "实际金额", "销售1", "销售2", "创建人", "调整生效时间", "所属大区", "创建时间"];

	var indexs = ["company_name", "shop_name", "contract_no", "adjust_paid", "adjust_status", "real_adjust_paid", "sale_user_name_1", "sale_user_name_2", "creator_name", "real_paid_date", "region_name", "created"]; //相当于sql的表头
	...
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractAdjustPaidList";

	var tabs = [{ name: "日志", url: "?controller=ContractController&act=contractAdjustLogByID" }];
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#contract_adjust_check' },
					'审核'
				)
			);
		}
