...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["平台", "订单编号", "状态", "用户名", "联系人", "客户名称", "卖家账号", "返款时间", "被引用", "创建人", "辅助处理人", "创建时间"];
	var indexs = ["platform_id", "trade_no", "rebate_status", "member_name", "link_man", "customer_name", "seller_account", "send_check_time", "is_quote", "creator_name", "assign_handler_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerRebateController&act=getCustomerRebateList";

	var tabs = [{ name: "日志", url: "?controller=CustomerRebateController&act=getCustomerRebateLogByID" }];
	...
	var SelectComponent = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'select',
	      { className: 'selectpicker ', key: this.props.name, name: this.props.name, onChange: this.onChangeValue, multiple: this.props.multiple, 'data-live-search': 'true', ref: this.props.name, id: 'test' },
	      rows
	    );
	  }
	});
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'customer_name' })
	          ),
	          React.createElement(
	            'td',
	            null,
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_rebate_chg_List' },
	        '修改'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_rebate_reject_List' },
	        '驳回'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_rebate_cancel_List' },
	        '取消'
	      ),
	      React.createElement(
	        'button',
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#customer_rebate_assign_List' },
	        '指派辅助处理人'
	      )
	    );
	  }
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerRebateController&act=customerRebateList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerRebateController&act=customerRebateList&" + page_data);
