...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["客户级别", "店铺名称", "官网名称", "行业", "类目", "所在省", "所在市", "创建人", "创建时间"];
	var indexs = ["customer_level", "shop_name", "company_name", "industry_name", "cate_name", "province_name", "city_name", "user_name", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "btn_chg", "target": "#document_chg_list", "name": "" }, { "title": "复制", "class2": "btn_copy", "target": "#document_copy_list", "name": "" }, { "title": "修改联系方式", "class2": "btn_link_chg", "target": "#document_link_chg_list", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerDocumentList";
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerController&act=customerDocumentList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerController&act=customerDocumentList&" + page_data);
