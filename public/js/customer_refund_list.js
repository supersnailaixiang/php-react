...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["销售1", "销售2", "公司名称", "店铺名称", "状态", "退款金额", "审核人", "审核时间", "创建人", "创建时间"];

	var indexs = ["sale_user_name_1", "sale_user_name_2", "company_name", "shop_name", "refund_status", "refund_amount", "check_user_name", "refund_confirm_time", "creator_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerRefundList";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#check_remark' },
					'查看/修改详情'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#refund_research_remark' },
					'添加技术备注'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#refund_imp_remark' },
					'添加实施备注'
				)
			);
		}
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerRefundList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerRefundList&" + page_data);
