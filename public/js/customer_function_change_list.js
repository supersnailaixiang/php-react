...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "省", "市", "曾用软件", "所属行业", "所属类目", "销售"];

	var indexs = ["company_name", "shop_name", "province_name", "city_name", "soft_name", "industry_name", "cate_name", "sale_user_name_1"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerFunctionChangeList";
	...
	var TableCommonRowComponent = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'tr',
				{ onClick: this.onClickRow, 'data-id': this.props.row.rec_id, 'data-order_version': this.props.row.order_version, 'data-status': this.props.row.status, 'data-province': this.props.row.province_id },
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#check_function_list' },
					'查看客户切换原因'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#append_function_list' },
					'追加客户切换原因'
				)
			);
		}
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'td',
								null,
								React.createElement(SelectComponent, { multiple: true, url: '?controller=DictDataController&act=getDictData&type=5', name: 'softs' })
							)
						),
						React.createElement(
							'td',
						...
						React.createElement(
							...
							React.createElement(
								'td',
								null,
								React.createElement(SelectComponent, { multiple: true, url: '?controller=DictDataController&act=getDictData&type=1', name: 'provinces' })
							)
						),
						React.createElement(
							'td',
						...
						React.createElement(
							...
							React.createElement(
								'td',
								null,
								React.createElement(SelectComponent, { multiple: true, url: '?controller=DictDataController&act=getDictData&type=6', name: 'industrys' })
							)
						),
						React.createElement(
							'td',
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			...
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerFunctionChangeList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerFunctionChangeList&" + page_data);
