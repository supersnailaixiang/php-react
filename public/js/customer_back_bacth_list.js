...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["批次名", "批次类型", "批次截止时间", "批次回访状态", "回访总数", "未回访", "回访失败", "回访结束", "抽查个数", "创建人", "创建时间"];

	var indexs = ["bacth_name", "bacth_type", "bacth_deadline", "visit_status", "sum_visit", "no_visit", "fail_visit", "end_visit", "check_visit", "user_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerBackBacthList";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#back_bacth_info' },
					'批次统计'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#back_bacth_check' },
					'批次抽查'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#back_pro_top5' },
					'回访统计'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#set_check_percent' },
					'设置抽查比例'
				)
			);
		}
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerBackBacthList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=getCustomerBackBacthList&" + page_data);
