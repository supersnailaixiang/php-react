...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "店铺名称", "合同金额", "服务费", "合同金额分布", "来源", "本期收款", "赠送项", "卖家账号", "销售1", "销售2", "成交时间"];

	var indexs = ["company_name", "shop_name", "contract_amount", "server_fee", "contract_info", "customer_source", "this_payment", "cost_info", "seller_account", "sale_user_name_1", "sale_user_name_2", "contract_sign_time"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerDaySuccessList";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, " ?controller=CustomerProcessController&act=CustomerDaySuccessList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, " ?controller=CustomerProcessController&act=CustomerDaySuccessList&" + page_data);
