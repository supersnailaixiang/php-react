...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["版本名称", "是否需要实施", "创建时间", "更新时间"];

	var indexs = ["order_name", "is_implement", "created", "modified"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "chg_event", "target": "#sys_version_chg", "name": "" }, { "title": "删除", "class2": "del_event", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=SysSetting&act=getSysVersionManageList";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#sys_version_add' },
					'添加'
				)
			);
		}
