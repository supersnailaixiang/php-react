...
/***/ function(module, exports, __webpack_require__) {
	...
	var BodyTableComponent = __webpack_require__(168);
	var MainMenu = __webpack_require__(169);
	var TurnPageComponent = __webpack_require__(170);
	var TabComponent = __webpack_require__(171);

	var heads = ["任务名称", "任务状态", "截止日期", "公司名称", "店铺名称", "任务描述", "指派人", "创建人", "创建时间"];
	...
	var user_flags = null;
	var datas = ['rec_id', 'type'];
	//不需要输入，返回值
	var operates = [{ "title": "修改任务", "class2": "chg_task", "target": "#chg_task_list", "name": "" }, { "title": "重新递交", "class2": "resend_task", "target": "", "name": "" }, { "title": "添加备注", "class2": "add_remark", "target": "#add_remark_list", "name": "" }, { "title": "上传回访表", "class2": "add_file", "target": "#add_visit_file", "name": "" }, { "title": "下载回访表", "class2": "show_file", "name": "" }]; // 需要输入
	var page_turn = page;
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#task_new_list' },
					'新建任务'
				)
			);
		}
	...
	var CustomerIntentionList = React.createClass({
		...
		render: function render() {
			var text = '';
			if (unaccept_task > 0) text = "你有未受理的任务" + unaccept_task + "条，请及时处理";
			return React.createElement(
				'div',
				null,
				...
				React.createElement(
					...
					text,
					'  crm视频FTP位置：/E:/FTP文档库/重构CRM操作视频讲解'
				),
				React.createElement('div', { style: { color: 'blue', margin: '5px' } }),
