...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["标题", "值班日期", "标准版", "企业版", "平台对接", "系统对接", "热敏", "备注", "修改时间", "创建时间"];

	var indexs = ["title", "date", "v1_assignors", "v2_assignors", "platform_assignors", "dock_assignors", "logis_assignors", "remark", "modified", "created"]; //相当于sql的表头

	var table_rows = result;
	var user_flags = flags;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "week_chg", "target": "#week_work_chg", "name": "" }, { "title": "登记值班人员", "class2": "week_user", "target": "#user_work_set", "name": "" }, { "title": "删除", "class2": "week_del", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=UserController&act=getUserWeekWork";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=7,9,12', name: 'assignors' })
						),
						React.createElement(
							'td',
							null,
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#add_week_work' },
					'新建值班安排'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#set_week_user' },
					'设置登记人'
				)
			);
		}
