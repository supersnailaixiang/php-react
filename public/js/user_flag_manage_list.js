...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["标记名称", "创建人", "修改时间", "创建时间"];
	var indexs = ["flag_name", "user_name", "modified", "created"];

	var table_rows = result;
	var datas = ['rec_id'];
	var operates = [{ "title": "修改标记", "class2": "update_flag", "target": "#", "name": "" }, { "title": "删除标记", "class2": "del_flag", "target": "#", "name": "" }];
	var page_turn = page;
	var url = "?controller=UserFlagController&act=getUserFlagManageList";
	var tabs = [];
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', id: 'user_flag_add' },
					'添加标记'
				)
			);
		}
	});
	var UserFlagManageList = React.createClass({
		displayName: 'UserFlagManageList',
	...
	ReactDOM.render(React.createElement(UserFlagManageList, { url: url }), document.getElementById('content'));
