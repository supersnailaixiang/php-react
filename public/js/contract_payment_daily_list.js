...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["到款时间", "到款类型", "到款金额", "公司名称", "店铺名称", "到款账户", "销售1", "销售2", "提供者", "客户创建者", "电话销售", "客户来源", "软件版本", "创建时间"];

	var indexs = ["collect_time", "payment_name", "payment_amount", "company_name", "shop_name", "collect_account", "sale_user_name1", "sale_user_name2",, "supplier_name", "customer_creator_name", "tel_name", "source_name", "order_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractPaymentDailyList";
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'a',
					{ href: '', id: 'contract_payment_export' },
					React.createElement(
						'button',
						null,
						'导出'
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=ContractController&act=contractPaymentDailyList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=ContractController&act=contractPaymentDailyList&" + page_data);
