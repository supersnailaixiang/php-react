...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["客户级别", "店铺名称", "官网名称", "行业", "类目", "所在省", "所在市", "店铺logo", "创建人", "通用排序", "类目排序", "创建时间"];
	var indexs = ["customer_level", "shop_name", "company_name", "industry_name", "cate_name", "province_name", "city_name", "logo", "user_name", "sort", "cate_sort", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "btn_chg", "target": "#document_chg_list", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerController&act=getCustomerDocumentHignList";

	var tabs = [{ name: "日志", url: "?controller=CustomerController&act=getCustomerDocumentLog" }];
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: true, url: '?controller=DictDataController&act=getDictData&type=6', name: 'cate_id', id: 'search_cate' })
	          ),
	          React.createElement(
	            'td',
	            null,
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerController&act=customerDocumentHignList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerController&act=customerDocumentHignList&" + page_data);
