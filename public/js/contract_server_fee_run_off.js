...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["状态", "公司名称", "店铺名称", "卖家账号", "预计收款时间", "应收金额", "实际收款时间", "实施离开现场时间", "到款账号", "销售", "实施", "创建人", "创建时间"];

	var indexs = ["collect_status", "company_name", "shop_name", "seller_account", "expect_collect_time", "collect_amount", "collect_time", "leave_scene_time", "collect_account", "sale_name", "imp_name", "creator_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractServerFeeRunOff";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=ContractController&act=getContractServerFeeRunOff&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=ContractController&act=getContractServerFeeRunOff&" + page_data);
