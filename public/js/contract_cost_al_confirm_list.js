...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["成本类型", "公司名称", "店铺名称", "数量", "辅助数量", "成本金额", "销售1", "销售2", "备注", "创建人", "合同编号", "所属大区", "创建时间"];

	var indexs = ["cost_name", "company_name", "shop_name", "num", "aux_num", "cost_amount", "sale_user_name_1", "sale_user_name_2", "remark", "creator_name", "contract_no", "region_name", "created"]; //相当于sql的表头
	...
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractCostAlConfirmList";

	var tabs = [{ name: "成本日志", url: "?controller=ContractController&act=contractCostLogByID" }];
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=DictDataController&act=getDictData&type=13&index=1', name: 'type' })
						),
						React.createElement(
							'td',
							null,
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'begin_confirm_date' }),
							React.createElement('br', null),
							React.createElement('input', { type: 'date', name: 'end_confirm_date' })
						)
					),
	...
	var TableCommonRowComponent = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				'tr',
				{ onClick: this.onClickRow, 'data-id': this.props.row.rec_id, 'data-contract_id': this.props.row.contract_id },
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					window.history.pushState(null, null, "?controller=ContractController&act=contractCostAlConfirmList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=ContractController&act=contractCostAlConfirmList&" + page_data);
