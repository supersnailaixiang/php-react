...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["卖家账号", "公司名称", "店铺名称", "批次", "状态", "回访时间", "本次回访人", "工单类型", "实施大区1", "实施大区2", "实施大区3", "实施1", "实施2", "实施3", "销售"];

	var indexs = ["seller_account", "company_name", "shop_name", "bacth_name", "status", "visit_date", "user_name", "work_type", "region_name", "region_name2", "region_name3", "imp_name1", "imp_name2", "imp_name3", "sale_name"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerSucessVisitBacthList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'select',
								{ name: 'work_type', className: 'selectpicker', 'data-live-search': 'true' },
								React.createElement(
									'option',
									{ value: '99' },
									'全部'
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#create_visit_back_bacth' },
					'创建批次'
				),
				React.createElement(
					'button',
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=CustomerProcessController&act=customerSucessVisitBacthList&" + data);
