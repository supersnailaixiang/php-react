...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["工单类型", "流程类型", "公司名称", "店铺名称", "订购版本", "客户希望卖家账号", "是否独享", "是否定制", "来源", "现用软件", "销售备注", "每日单量", "销售"];

	var indexs = ["work_type", "flow_type", "company_name", "shop_name", "order_name", "hope_seller_account", "is_share", "is_order", "source_name", "old_software", "sale_remark", "average_order_num", "sale_man"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "驳回", "class2": "customer_reject", "target": "#customer_reject_list", "name": "" }, { "title": "开库", "class2": "customer_check", "target": "#customer_check_list", "name": "" }, { "title": "合同", "class2": "contract_check", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerProcessController&act=getCustomerOpenList";

	var tabs = [{ name: "切换原因", url: "?controller=CustomerProcessController&act=getCustomerFunctionListByID" }, { name: "事件", url: "?controller=EventController&act=getEventListByWorkID" }, { name: "日志", url: "?controller=CustomerProcessController&act=customerWorkLogList" }];
