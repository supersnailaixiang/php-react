...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["创建人", "日期", "审核人", "状态", "目的地客户名称", "起点", "终点", "火车", "飞机", "大巴", "地铁", "公交", "打车", "住宿", "餐费", "打车，住宿，餐费原因", "快递费", "电话补助", "小计", "备注"];

	var indexs = ["creator_name", "user_date", "check_name", "status", "target_name", "start_address", "end_address", "train_fee", "plane_fee", "bus_fee", "subway_fee", "transport_fee", "car_fee", "room_fee", "food_fee", "reason", "mail_fee", "tel_assign", "total_fee", "remark"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerOperationController&act=getCustomerExpenseByID";
	...
	var TableCommonRowComponent = React.createClass({
		...
		render: function render() {
			...
			this.props.indexs.forEach(function (index) {
				...
				if (index == "func_href") {
					tds.push(React.createElement(
						...
						React.createElement(
							'a',
							{ href: this.props.row[index], style: { color: 'red' } },
							'go'
						)
					));
				} else {
			...
			return React.createElement(
				'tr',
				{ onClick: this.onClickRow, 'data-id': this.props.row.rec_id, 'data-status': this.props.row.status, 'data-province': this.props.row.province_id },
		...
		render: function render() {
			...
			rows.push(React.createElement(
				...
				React.createElement(
					'td',
					null,
					this.props.data.train_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.plane_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.bus_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.subway_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.transport_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.car_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.room_fee
				),
				React.createElement(
					'td',
					null,
				...
				React.createElement(
					'td',
					null,
					this.props.data.mail_fee
				),
				React.createElement(
					'td',
					null,
					this.props.data.tel_assign
				),
				React.createElement(
					'td',
					null,
					this.props.data.total_fee
				)
			));
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#btn_add_function_list' },
					'添加'
				)
			);
		}
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement(SelectComponent, { multiple: false, url: '?controller=UserController&act=getUserByDept&depts=1,3', name: 'creator' })
						),
						React.createElement(
							'td',
							null,
						...
						'日期:',
						React.createElement('input', { type: 'text', name: 'begin_date' }),
						React.createElement('input', { type: 'text', name: 'end_date' }),
						React.createElement(
							'td',
							null,
	...
	var CustomerIntentionList = React.createClass({
		...
		getInitialState: function getInitialState() {
			return { rows: table_rows, search_data: '', page: page_turn, data: table_data };
		},
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(BodyTableComponent, { data: this.state.data, heads: heads, indexs: indexs, rows: this.state.rows, operates: operates }),
