...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["软件名称", "提成", "修改时间", "创建时间"];

	var indexs = ["soft_name", "percent", "modified", "created"]; //相当于sql的表头

	var table_rows = result;
	var user_flags = flags;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改竞争对手信息", "class2": "btn_chg", "target": "#compete_list_chg", "name": "" }, { "title": "删除", "class2": "btn_del", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=UserController&act=getUserCompeteManageList";
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'soft_name' })
						),
						React.createElement(
							'td',
							null,
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'created_start' })
						),
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'created_end' })
						),
						React.createElement(
							'td',
							null,
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'modified_start' })
						),
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'date', name: 'modified_end' })
						)
					)
				)
			);
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#add_compete' },
					'添加竞争对手'
				)
			);
		}
