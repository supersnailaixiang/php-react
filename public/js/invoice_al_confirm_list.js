...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["订单编号", "状态", "公司名称", "卖家账号", "发票类型", "邮寄类型", "发票金额", "一般纳税人", "纳税人识别号", "结算单号", "快递", "快递单号", "订购时间", "备注", "创建人", "确认时间", "邮寄时间", "创建时间"];
	var indexs = ["trade_no", "invoice_status", "company_name", "seller_account", "invoice_type", "send_type", "invoice_amount", "is_general_taxpayer", "taxpayer_number", "final_no", "express_company", "tracking_number", "order_date", "remark", "creator_name", "confirm_date", "invoice_time", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerInvoiceController&act=getCustomerInvoiceAlConfirmList";
	...
	var SearchFormComponent = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { ref: this.props.name, id: 'search_form', style: { padding: '5px' }, key: 'serach_form_list' },
	      React.createElement(
	        'table',
	        null,
	        React.createElement(
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'a',
	        { id: 'customer_invoice_export_List' },
	        React.createElement(
	          'button',
	          null,
	          '导出'
	...
	var CustomerIntentionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, " ?controller=CustomerInvoiceController&act=customerInvoiceAlConfirmList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, " ?controller=CustomerInvoiceController&act=customerInvoiceAlConfirmList&" + page_data);
