...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["销售1", "销售2", "公司名称", "店铺名称", "状态", "退款金额", "提供者", "客户创建者", "电话销售", "客户来源", "软件版本", "审核人", "审核时间", "创建人", "创建时间"];

	var indexs = ["sale_user_name_1", "sale_user_name_2", "company_name", "shop_name", "refund_status", "refund_amount", "supplier_name", "customer_creator_name", "tel_name", "source_name", "order_name", "check_user_name", "refund_confirm_time", "creator_name", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractAlRefundConfirm";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=ContractController&act=contractAlRefundConfirm&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=ContractController&act=contractAlRefundConfirm&" + page_data);
