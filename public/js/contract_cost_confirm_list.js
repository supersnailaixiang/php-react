...
/***/ function(module, exports, __webpack_require__) {
	...
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "确认", "class2": "btn_confirm", "target": "#cost_confirm_list", "name": "" }, { "title": "查看合同", "class2": "check_contract", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractCostConfirmList";
