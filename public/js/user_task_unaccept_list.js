...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["任务名称", "任务状态", "公司名称", "店铺名称", "任务描述", "指派人", "创建人", "创建时间"];

	var indexs = ["task_name", "status", "company_name", "shop_name", "description", "assignors_name", "creator_name", "created"]; //相当于sql的表头

	var table_rows = result;
	var user_flags = null;
	var datas = ['rec_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改任务", "class2": "chg_task", "target": "#chg_task_list", "name": "" }]; // 需要输入

	/*{"title":"重新递交","class2":"resend_task","target":"","name":""},*/

	var page_turn = page;
	var url = "?controller=TaskController&act=getUserTaskUnacceptList";

	var tabs = [{ name: "日志", url: "?controller=TaskController&act=getUserTaskListByID" }];
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'td',
							null,
							React.createElement('input', { type: 'text', name: 'task_name' })
						),
						React.createElement(
							'td',
							null,
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#task_accept_list' },
					'接受'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#task_end_list' },
					'完成'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#task_reject_list' },
					'驳回'
				),
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#task_cancel_list' },
					'取消'
				)
			);
		}
