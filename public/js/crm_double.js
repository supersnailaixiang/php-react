$(function(){
	...
	$("table[data-body='body_double']").delegate("tr:not(first)","click",function(){
		//$("table tr").find(".tr_selected").css("background-color","white").removeClass("tr_selected");
	//	$(this).parents("table").find(".tr_selected").css("background-color","white").removeClass("tr_selected");
