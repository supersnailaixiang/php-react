...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["销售1", "销售2", "公司名称", "店铺名称", "最近一次跟进内容", "最近跟进时间", "联系客户时间", "分配给销售", "分配给销售部门时间", "销售回转电销时间", "分配电销时间", "电话销售", "修改时间", "创建时间"];

	var indexs = ["sale_user_name_1", "sale_user_name_2", "company_name", "shop_name", "event_content", "event_time", "link_customer_time", "assign_sales_man_time", "assign_sales_time", "back_tel_time", "assign_tel_man_time", "tel_name", "modified", "created"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getCustomerUndealManageList";

	var tabs = [{ name: "事件", url: "?controller=EventController&act=getEventListByID" }];
	...
	var SearchButton = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'button',
					{ 'data-toggle': 'modal', 'data-target': '#customer_undeal_setting' },
					'设置'
				)
			);
		}
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=UserPerformController&act=customerUndealManageList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=UserPerformController&act=customerUndealManageList&" + page_data);
					this.setState({ rows: result.result, page: result.page });
				}.bind(this),
				error: function (xhr, status, err) {
