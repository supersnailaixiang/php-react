...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["成本类型", "状态", "公司名称", "店铺名称", "数量", "辅助数量", "成本金额", "销售1", "销售2", "创建人", "合同编号", "所属大区", "创建时间"];

	var indexs = ["cost_name", "cost_status", "company_name", "shop_name", "num", "aux_num", "cost_amount", "sale_user_name_1", "sale_user_name_2", "creator_name", "contract_no", "region_name", "created"]; //相当于sql的表头
	...
	var page_turn = page;
	var url = "?controller=ContractController&act=getContractCostList";
	...
	var CustomerIntentionList = React.createClass({
		...
		onSearchSubmit: function onSearchSubmit(data) {
			$.ajax({
				...
				success: function (result) {
					...
					window.history.pushState(null, null, "?controller=ContractController&act=contractCostList&" + data);
		...
		handleTablePage: function handleTablePage(page) {
			...
			$.ajax({
				...
				data: page_data,
				success: function (result) {
					window.history.pushState(null, null, "?controller=ContractController&act=contractCostList&" + page_data);
