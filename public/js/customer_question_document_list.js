...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["归档号", "产品", "父模块", "子模块", "归档类型", "标题", "归档问题数", "状态", "归档人", "归档时间"];
	var indexs = ["doc_id", "product_type", "main_name", "sub_name", "question_type", "title", "question_num", "doc_status", "user_name", "created"]; //相当于sql的表头

	var table_rows = result;
	var datas = ['question_id'];
	//不需要输入，返回值
	var operates = [{ "title": "修改", "class2": "btn_update", "target": "#document_update_div", "name": "" }, { "title": "删除档案", "class2": "btn_del", "target": "", "name": "" }]; // 需要输入
	var page_turn = page;
	var url = "?controller=CustomerQuestionController&act=getCustomerQuestionDocumentList";

	var tabs = [{ name: "日志", url: "?controller=CustomerQuestionController&act=documentLogByID" }];
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('input', { type: 'text', name: 'doc_id' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement(SelectComponent, { multiple: false, url: '?controller=CustomerQuestionController&act=customerQuestionType&status=1&type=2', name: 'question_type' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('select', { name: 'module_pid', id: 'search_pid', className: 'selectpicker' })
	          ),
	          React.createElement(
	            'td',
	            null,
	          ...
	          React.createElement(
	            'td',
	            null,
	            React.createElement('select', { name: 'submodule_id', id: 'search_sub_id', className: 'selectpicker' })
	          ),
	          React.createElement(
	            'td',
	            null,
	...
	var SearchButton = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_document_type' },
	        '归档问题类型'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#question_document_type_add' },
	        '添加归档类型'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#set_document_man' },
	        '设置归档人'
	      ),
	      React.createElement(
	        'button',
	        { 'data-toggle': 'modal', 'data-target': '#check_document_list' },
	        '查看归档问题'
	      ),
	      React.createElement(
	        'a',
	        { id: 'check_document_records' },
	        React.createElement(
	          'button',
	          null,
	          '查看关联问题'
	...
	var CustomerQuestionList = React.createClass({
	  ...
	  onSearchSubmit: function onSearchSubmit(data) {
	    $.ajax({
	      ...
	      success: function (result) {
	        ...
	        window.history.pushState(null, null, "?controller=CustomerQuestionController&act=customerQuestionDocumentList&" + data);
	  ...
	  handleTablePage: function handleTablePage(page) {
	    ...
	    $.ajax({
	      ...
	      data: page_data,
	      success: function (result) {
	        window.history.pushState(null, null, "?controller=CustomerQuestionController&act=customerQuestionDocumentList&" + page_data);
	...
	ReactDOM.render(React.createElement(CustomerQuestionList, { url: url }), document.getElementById('document_question'));
