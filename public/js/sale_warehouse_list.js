...
/***/ function(module, exports, __webpack_require__) {
	...
	var heads = ["公司名称", "销售", "卖家账号", "合同金额", "合同金额分布", "是否开通", "操作人", "开通时间"];

	var indexs = ["company_name", "sale_name", "seller_account", "contract_amount", "contract_info", "status", "oprator", "open_time"]; //相当于sql的表头
	...
	var operates = []; // 需要输入
	var page_turn = page;
	var url = "?controller=UserPerformController&act=getSaleWarehouseList";
	...
	var CustomerIntentionList = React.createClass({
	    ...
	    onSearchSubmit: function onSearchSubmit(data) {
	        $.ajax({
	            ...
	            success: function (result) {
	                ...
	                window.history.pushState(null, null, "?controller=UserPerformController&act=saleWarehouseList&" + data);
	    ...
	    handleTablePage: function handleTablePage(page) {
	        ...
	        $.ajax({
	            ...
	            data: page_data,
	            success: function (result) {
	                window.history.pushState(null, null, "?controller=UserPerformController&act=saleWarehouseList&" + page_data);
